...
gnome-terminal -e '/home/name/spark/bin/spark-submit --jars spark-streaming-kafka-0-8-assembly_2.11-2.0.0.jar stream-processing.py stock-analyzer average-stock-price 192.168.99.100:9092'
...
gnome-terminal --working-directory=nodejsdirectory -e 'node index.js --port=3000 --redis_host=192.168.99.100 --redis_port=6379 --channel=average-stock-price'
